        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
				...
				"youtubeURL": {
                    ...
                    "alertText": "* Link-ul de Youtube video este invalid"
                },
				"latitude": {                    
                    "regex": /^(\+|-)?(?:90(?:(?:\.0{1,6})?)|(?:[0-9]|[1-8][0-9])(?:(?:\.[0-9]{1,16})?))$/,
                    "alertText": "* Latitudinea este invalida"
                },
				"longitude": {                    
                    "regex": /^(\+|-)?(?:180(?:(?:\.0{1,6})?)|(?:[0-9]|[1-9][0-9]|1[0-7][0-9])(?:(?:\.[0-9]{1,16})?))$/,
                    "alertText": "* Longitudinea este invalida"
                },
				"hiddenRecaptcha": {
						required: function() {
                ...
                "lettersAtLeastOneNumber": {
                    "regex": /^[^\w\d]*(([0-9]+.*[A-Za-z]+.*)|[A-Za-z]+.*([0-9]+.*))$/,
                    "alertText": "* Trebuie sa folosesti doar litere si cel putin o cifra"
                },
                "alphanumericExceptOnlyNumbersAndSpecialChars": {
                    "regex": /^(?![0-9-'.,&@:?!()[\]{}|*+~<>_=^%`"$#/\\/r\s]*$)[a-zA-ZâăáéèîóöőøșşțţÂĂÁÉÈÎÓÖŐØȘŞȚŢ0-9-'.,&@:;?!()[\]{}|*+~<>_=^%`"$#/\\/r\s]+$/,
                    "alertText": "* Contine caractere care nu sunt permise, sau contine doar cifre"
                },
